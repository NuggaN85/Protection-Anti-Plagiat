...
function getUserIP()
{
    foreach (array('HTTP_PROXY_CONNECTION', 'HTTP_VIA', 'VIA', 'HTTP_X_REAL_IP', 'CLIENT_IP', 'FORWARDED_FOR_IP', 'X_FORWARDED_FOR', 'X_FORWARDED', 'FORWARDED', 'FORWARDED_FOR', 'HTTP_FORWARDED_FOR_IP', 'HTTP_CLIENT_IP', 'HTTP_CF_CONNECTING_IP', 'HTTP_X_FORWARDED_FOR', 'HTTP_X_FORWARDED', 'HTTP_X_FORWARDED_SSL', 'HTTP_X_CLUSTER_CLIENT_IP', 'HTTP_FORWARDED_FOR', 'HTTP_FORWARDED', 'HTTP_FORWARDED_SSL', 'REMOTE_ADDR') as $key)
    {
