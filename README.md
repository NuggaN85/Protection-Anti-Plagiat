...
<strong>:warning:</strong>
Pour les fichiers en <strong>html</strong>, mettre " ```PHP <?php require_once($base_dir.'papprotect/papprotect.php'); ?> ``` " avant la balise " <!DOCTYPE html> dans les pages souhaitées de votre site web.
